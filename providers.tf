...
provider "helm" {
  kubernetes {
    host = kind_cluster.otelplay.endpoint

    client_certificate     = kind_cluster.otelplay.client_certificate
    client_key             = kind_cluster.otelplay.client_key
    cluster_ca_certificate = kind_cluster.otelplay.cluster_ca_certificate
  }
}
